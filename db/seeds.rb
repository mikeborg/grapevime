...
primary_comments = Comment.create([
  {message: "This is a primary comment.", sm_type: sm_array.sample, popularity: Random.rand(999999)},
  {message: "This is a primary comment.", sm_type: sm_array.sample, popularity: Random.rand(999999)},
  {message: "This is a primary comment.", sm_type: sm_array.sample, popularity: Random.rand(999999)},
  {message: "This is a primary comment.", sm_type: sm_array.sample, popularity: Random.rand(999999)},
  {message: "This is a primary comment.", sm_type: sm_array.sample, popularity: Random.rand(999999)},
...
primary_comments.each do |primary_comment|
  comment_array = primary_comment.comments.create([
    {message: "This is a secondary comment. ##{primary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a secondary comment. ##{primary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a secondary comment. ##{primary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)}])
...
secondary_comments.each do |secondary_comment|
  comment_array = secondary_comment.comments.create([
    {message: "This is a tertiary comment. ##{secondary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a tertiary comment. ##{secondary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a tertiary comment. ##{secondary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)}])
  comment_array.each do |comment|
...
tertiary_comments.each do |tertiary_comment|
  comment_array = tertiary_comment.comments.create([
    {message: "This is a quaternary comment. ##{tertiary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a quaternary comment. ##{tertiary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a quaternary comment. ##{tertiary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)}])
  comment_array.each do |comment|
...
quaternary_comments.each do |quaternary_comment|
  comment_array = quaternary_comment.comments.create([
    {message: "This is a quinary comment. ##{quaternary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a quinary comment. ##{quaternary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a quinary comment. ##{quaternary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)}])
    comment_array.each do |comment|
...
quinary_comments.each do |quinary_comment|
  comment_array = quinary_comment.comments.create([
    {message: "This is a senary comment. ##{quinary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a senary comment. ##{quinary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a senary comment. ##{quinary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)}])
    comment_array.each do |comment|
...
senary_comments.each do |senary_comment|
  comment_array = senary_comment.comments.create([
    {message: "This is a septenary comment. ##{senary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a septenary comment. ##{senary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)},
    {message: "This is a septenary comment. ##{senary_comment.hashtags.first.tag}", sm_type: sm_array.sample, popularity: Random.rand(999999)}])
    comment_array.each do |comment|
